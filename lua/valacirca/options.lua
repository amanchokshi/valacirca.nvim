...
-- [[ Highlights ]] {{{
-- Function to set highlight groups for hover window to match completion menu
local function set_hover_highlights()
  vim.api.nvim_set_hl(0, 'NormalFloat', { link = 'CmpPmenu' })
  vim.api.nvim_set_hl(0, 'FloatBorder', { link = 'CmpPmenuBorder' })
end

-- Apply the highlight changes immediately
